...
import 'package:klinik/ui/screen/history/history_item.dart';
            ...
            HistoryItem(
              items: List.generate(
                ...
                (index) => History(
                  ...
                  DateTime(
                    currentDt.year,
                    currentDt.month - index,
                    currentDt.day - index,
                    currentDt.hour - index,
                    currentDt.minute - index,
                    currentDt.second,
                    currentDt.millisecond,
                    currentDt.microsecond,
                  ).toString(),
                  "Pemeriksaan ${checks[index]}",
                  false,
                ),
              ),
            ),
